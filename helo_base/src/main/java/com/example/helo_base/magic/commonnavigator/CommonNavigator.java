package com.example.helo_base.magic.commonnavigator;
...
import com.example.helo_base.magic.ScrollState;
import com.example.helo_base.magic.commonnavigator.abs.CommonNavigatorAdapter;
import com.example.helo_base.magic.commonnavigator.abs.IMeasurablePagerTitleView;
...
import com.example.helo_base.magic.commonnavigator.model.PositionData;
...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private void init() {
        ...
        View root;
        if (mAdjustMode) {//item少时设置LinearLayout等宽(默认)，item多时设置HorizontalScrollView
    ...
    private void preparePositionData() {
        ...
        for (int i = 0, j = mNavigatorHelper.getTotalCount(); i < j; i++) {
            ...
            if (v != null) {
                ...
                Log.e("CommonNavigator", "left= " + v.getLeft());
                Log.e("CommonNavigator", "top= " + v.getTop());
                Log.e("CommonNavigator", "right= " + v.getRight());
                Log.e("CommonNavigator", "bottom= " + v.getBottom());
