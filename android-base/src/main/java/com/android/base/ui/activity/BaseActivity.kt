package com.android.base.ui.activity
...
//        val nightMode = com.example.pandas.utils.DarkModeUtils.getNightModel(this)
...
//    }
    ...
    private val networkCallback = object : ConnectivityManager.NetworkCallback() {
        ...
        override fun onAvailable(network: Network) {
            ...
            showToast("===网络连接成功，通知可以使用时调用====onAvailable=====")
        ...
        override fun onLosing(network: Network, maxMsToLive: Int) {
            ...
            showToast("===网络正在断开连接====onLosing=====")
            Log.e("1mean", "===网络正在断开连接====onLosing=====")
        }

        override fun onLost(network: Network) {
            super.onLost(network)
            showToast("===网络已断开连接====onLost=====")
