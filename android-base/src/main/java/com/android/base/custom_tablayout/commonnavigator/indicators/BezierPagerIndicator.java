package com.android.base.custom_tablayout.commonnavigator.indicators;
...
import com.android.base.custom_tablayout.FragmentContainerHelper;
import com.android.base.custom_tablayout.UIUtil;
...
public class BezierPagerIndicator extends View implements IPagerIndicator {
    ...
    private void init(Context context) {
        ...
        mMaxCircleRadius = UIUtil.INSTANCE.dip2px(context, 3.5);
        mMinCircleRadius = UIUtil.INSTANCE.dip2px(context, 2);
        mYOffset = UIUtil.INSTANCE.dip2px(context, 1.5);
    }
