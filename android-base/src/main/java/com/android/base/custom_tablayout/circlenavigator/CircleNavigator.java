package com.android.base.custom_tablayout.circlenavigator;
...
public class CircleNavigator extends View implements IPagerNavigator {
    ...
    private void init(Context context) {
        ...
        mRadius = UIUtil.INSTANCE.dip2px(context, 3);
        mCircleSpacing = UIUtil.INSTANCE.dip2px(context, 8);
        mStrokeWidth = UIUtil.INSTANCE.dip2px(context, 1);
    }
