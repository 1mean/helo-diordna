package com.android.base.custom_tablayout.commonnavigator.titles;
...
public class ClipPagerTitleView extends View implements IMeasurablePagerTitleView {
    ...
    private void init(Context context) {
        int textSize = UIUtil.INSTANCE.dip2px(context, 16);
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setTextSize(textSize);
        int padding = UIUtil.INSTANCE.dip2px(context, 10);
