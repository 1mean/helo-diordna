package com.life.publish.lib_selector.adapter.holder;
...
public class PreviewAudioHolder extends BasePreviewHolder {
    ...
    protected void loadImage(LocalMedia media, int maxWidth, int maxHeight) {
        tvAudioName.setCompoundDrawablesRelativeWithIntrinsicBounds(0, R.mipmap.ps_ic_audio_play_cover, 0, 0);
    }
    ...
    private void playerDefaultUI(boolean isResetProgress) {
        ...
        setBackFastUI(false);
        ivPlayButton.setImageResource(R.mipmap.ps_ic_audio_play);
        if (mPreviewEventListener != null) {
    ...
    private void playerIngUI() {
        startUpdateProgress();
        setBackFastUI(true);
        ivPlayButton.setImageResource(R.mipmap.ps_ic_audio_stop);
    }
