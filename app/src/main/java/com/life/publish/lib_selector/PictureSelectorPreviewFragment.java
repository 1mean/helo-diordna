...
import com.life.publish.lib_selector.adapter.holder.PreviewGalleryAdapter;
import com.life.publish.lib_selector.adapter.holder.PreviewVideoHolder;
...
import com.life.publish.lib_selector.basic.PictureMediaScannerConnection;
import com.life.publish.lib_selector.config.Crop;
...
import com.life.publish.lib_selector.decoration.HorizontalItemDecoration;
import com.life.publish.lib_selector.decoration.WrapContentLinearLayoutManager;
import com.life.publish.lib_selector.dialog.PictureCommonDialog;
import com.life.publish.lib_selector.entity.LocalMedia;
import com.life.publish.lib_selector.entity.MediaExtraInfo;
...
import com.life.publish.lib_selector.magical.MagicalView;
import com.life.publish.lib_selector.magical.OnMagicalViewCallback;
import com.life.publish.lib_selector.magical.ViewParams;
...
import com.life.publish.lib_selector.utils.DownloadFileUtils;
...
public class PictureSelectorPreviewFragment extends PictureCommonFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        nextView.setOnClickListener(v -> {
            ...
            Intent intent = new Intent(getActivity(),PicturePublishActivity.class);
            intent.putParcelableArrayListExtra("photos",mData);
            getActivity().startActivity(intent);

//            PicturePublishFragment publishFragment = PicturePublishFragment.Companion.newInstance();
//            publishFragment.addSelectedData(mData);
//            publishFragment.addCloseListener(cListener);
//            FragmentInjectManager.injectFragment(getActivity(), "PicturePublishFragment", publishFragment);
        });
    }
