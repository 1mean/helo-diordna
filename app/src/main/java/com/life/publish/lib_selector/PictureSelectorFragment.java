...
import com.life.publish.lib_selector.adapter.PictureImageGridAdapter;
import com.life.publish.lib_selector.adapter.PictuteSelectedAdapter;
import com.life.publish.lib_selector.adapter.SelectorItemDecoration;
import com.life.publish.lib_selector.animators.AlphaInAnimationAdapter;
import com.life.publish.lib_selector.animators.AnimationType;
import com.life.publish.lib_selector.animators.SlideInBottomAnimationAdapter;
import com.life.publish.lib_selector.basic.FragmentInjectManager;
import com.life.publish.lib_selector.basic.IPictureSelectorEvent;
import com.life.publish.lib_selector.basic.PictureCommonFragment;
import com.life.publish.lib_selector.config.InjectResourceSource;
import com.life.publish.lib_selector.config.PermissionEvent;
import com.life.publish.lib_selector.config.PictureConfig;
import com.life.publish.lib_selector.config.PictureMimeType;
import com.life.publish.lib_selector.config.SelectMimeType;
import com.life.publish.lib_selector.config.SelectModeConfig;
import com.life.publish.lib_selector.decoration.GridSpacingItemDecoration;
import com.life.publish.lib_selector.dialog.AlbumListPopWindow;
...
import com.life.publish.lib_selector.interfaces.OnAlbumItemClickListener;
import com.life.publish.lib_selector.interfaces.OnQueryAlbumListener;
import com.life.publish.lib_selector.interfaces.OnQueryAllAlbumListener;
import com.life.publish.lib_selector.interfaces.OnQueryDataResultListener;
import com.life.publish.lib_selector.interfaces.OnRecyclerViewPreloadMoreListener;
import com.life.publish.lib_selector.interfaces.OnRecyclerViewScrollListener;
import com.life.publish.lib_selector.interfaces.OnRecyclerViewScrollStateListener;
import com.life.publish.lib_selector.interfaces.OnRequestPermissionListener;
import com.life.publish.lib_selector.loader.IBridgeMediaLoader;
import com.life.publish.lib_selector.loader.LocalMediaLoader;
import com.life.publish.lib_selector.loader.LocalMediaPageLoader;
import com.life.publish.lib_selector.magical.BuildRecycleItemViewParams;
import com.life.publish.lib_selector.manager.SelectedManager;
...
import com.life.publish.lib_selector.utils.AnimUtils;
import com.life.publish.lib_selector.utils.DateUtils;
import com.life.publish.lib_selector.utils.DensityUtil;
import com.life.publish.lib_selector.utils.DoubleUtils;
import com.life.publish.lib_selector.utils.StyleUtils;
import com.life.publish.lib_selector.utils.ToastUtils;
import com.life.publish.lib_selector.utils.ValueOf;
import com.life.publish.lib_selector.widget.BottomNavBar;
import com.life.publish.lib_selector.widget.CompleteSelectView;
import com.life.publish.lib_selector.widget.RecyclerPreloadView;
import com.life.publish.lib_selector.widget.SlideSelectTouchListener;
import com.life.publish.lib_selector.widget.SlideSelectionHandler;
...
public class PictureSelectorFragment extends PictureCommonFragment
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        selectRecycler = view.findViewById(R.id.recycler_selects);
        selectLayout = view.findViewById(R.id.clayout_selected);
        nextView = view.findViewById(R.id.clayout_selector_next);
    ...
    private void showDataNull() {
        if (selectorConfig.currentLocalMediaFolder == null
            ...
            tvDataEmpty.setCompoundDrawablesRelativeWithIntrinsicBounds(0, R.mipmap.ps_ic_no_data, 0, 0);
