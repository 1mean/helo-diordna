...
public class TitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    public void setTitleBarStyle() {
        Log.e("1mean","setTitleBarStyle");
        if (config.isPreviewFullScreenMode) {
            Log.e("1mean","1111setTitleBarStyle");
        ...
        if (config.isOnlySandboxDir) {
            ivArrow.setImageResource(R.mipmap.ps_ic_trans_1px);
        } else {
        ...
        if (StyleUtils.checkStyleValidity(deleteBackgroundResource)) {
            ...
            ivDelete.setBackgroundResource(R.mipmap.ps_ic_delete);
        }
    }
