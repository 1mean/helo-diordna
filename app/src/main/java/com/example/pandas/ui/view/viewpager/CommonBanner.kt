 ...
 * @version: v1.0
 */
class CommonBanner : RelativeLayout, LifecycleObserver {
    ...
    private fun addPageTransformer(transformer: ViewPager2.PageTransformer): CommonBanner {
        compositePageTransformer?.addTransformer(transformer)
        return this
    }

    fun setLifecycleRegistry(lifecycleRegistry: Lifecycle): CommonBanner {
     ...
     */
    public fun setPagePadding(lastPageWidth: Int, nextPageWidth: Int, itemPadding: Int): CommonBanner {
    ...
    //设置轮播指示器
    fun setIndicator(mIndicator: Indicator, attachToBanner: Boolean): CommonBanner {
     ...
     * @version: v1.0
     */
    fun setAdapter(adapter: RecyclerView.Adapter<out RecyclerView.ViewHolder>): CommonBanner {
    ...
    fun addPageChangeListener(pageChangeListener: PagerChangedListener): CommonBanner {
     ...
     */
    fun setAutoPlayed(autoPlay: Boolean): CommonBanner {
        isAutoPlay = autoPlay
